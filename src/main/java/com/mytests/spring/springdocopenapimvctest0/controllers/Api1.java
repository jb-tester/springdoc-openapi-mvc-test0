...
public interface Api1 {
    ...
    @PostMapping(value = "/test_api1/add", consumes = { "application/json", "application/xml", "application/x-www-form-urlencoded" })
    void addData(
            @Parameter(description = "Create new data", required = true) @Valid @RequestBody(description = "Created data object", required = true,
                    content = @Content(
